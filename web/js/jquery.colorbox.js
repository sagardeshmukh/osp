...
(function ($) {
	...
	cboxPublic = $.fn.colorbox = function (options, callback) {
        ...
        $thumbContainer.append("<h4 style=\"margin:2px;\">Product Picture</h4>");
		$this.each(function () {
            ...
            $thumbContainer.append($(this).html());
            //thumbnails
            //console.log();
		});
	...
	cboxPublic.init = function () {
		...
		$content = $div("Content").append(
            ...
            $thumbContainer = $div("ThumbsContainer"),
			$title = $div("Title"),
			$current = $div("Current"),
	...
	cboxPublic.resize = function (object) {
        ...
        $($thumbs[index]).css("border", "1px solid #808080");
		function getWidth(){
            //console.log(settings.w || $loaded.width());
			settings.w = settings.w || $loaded.width();
			settings.w = settings.mw && settings.mw < settings.w ? settings.mw : settings.w;
			return settings.w - 100;
		}
		function getHeight(){
        ...
        $thumbContainer.css({height: getHeight() +  11});
		$loaded.hide()
