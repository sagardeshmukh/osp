...
<div class="item<?php if ($product->hasDoping(myConstants::$DIFFERENT))
  ...
  <div class="wrap">
    ...
    <div class="info"> 
	  <h3> <a href="<?php echo url_for("@album?product_id=".$product->getId()) ?>">
		<div align="justify" style="height:50px;"><?php echo truncate_text(getProductName($product, $sf_user->getCulture()),'60','..'); ?></div>
		</a> 
	  </h3>
