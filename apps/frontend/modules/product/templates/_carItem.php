...
<div class="item<?php if ($product->hasDoping(myConstants::$DIFFERENT))
  ...
  echo " featured" ?>">
  <div class="wrap">
    <div class="image"> <a href="<?php echo url_for("@album?product_id=".$product->getId()) ?>" ><?php echo image_tag($product->getImagePath("s_"), array("width" => 150)); ?></a> </div>
    <div class="info">
      <h3> <a href="<?php echo url_for("@album?product_id=".$product->getId()) ?>"><div align="justify" style="height:50px;"><?php echo truncate_text(getProductName($product, $sf_user->getCulture()),'60','..'); ?></div></a> </h3>
      ...
      <p class="compare-hide" style="display: none;">
        ...
        <?php echo image_tag($product->getImagePath("t_"), 'style=display:none;'); ?> </p>
      <ul>
