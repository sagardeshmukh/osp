...
<script type="text/javascript">
	...
	var flashvars = {
		...
		paramXMLPath: "<?php echo url_for('@xml_param?ObjectID='.$product->getId(), true) ?>",
	...
	swfobject.embedSWF("/swf/slideshowpro2.swf", "flashcontent", "697", "510", "9.0.0", false, flashvars, params, attributes);
...
<div class="content">
  ...
  <div class="inline left" style="width:697px;">
    <!-- picture -->
   <!-- <div style="margin-bottom: 20px; float: left;" class="picture-browser-content">
    ...
    <div class="box clear" style="width:700px;">
      ...
      <div class="boxContent">
        <?php if($xType == 'cars' || $xType == 'rental') { ?>
					  <div class="boxWrap">
